...
void TitleScene::draw()
{
	...
	DrawStringToHandle(Game::kScreenWidth - 70, Game::kScreenHeight - 55, "決定", 0xffffff, UIfontHandle);*/
...
{
	fadeValue = static_cast<int>(255 * (static_cast<float>(fadeTimer_) / static_cast<float>(fade_interval)));
	if (--fadeTimer_ == 0) {
